...
function zoom(){
  var biggieVar = document.getElementById("biggie");
  biggieVar.style.fontSize = "150%";
}
...
var menuItems = ["McTeri", " Haupia Pie ", " Chcolate Sundae"];
function valueMenu(){
  var McMenu = document.getElementById("menu");
  McMenu.innerHTML = menuItems;
}
...
function redFace(){
  var ginChange = document.getElementById("drink");
  ginChange.style.color = "red";
  ginChange.style.fontSize = "20px";
}
...
*/
showHide.addEventListener("click", showHideSecret);
function showHideSecret(){
  var secretElem = document.getElementById("freedom");
